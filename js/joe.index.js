			...
			if (_.mode === 'default') {
				return `
                    <li class="joe_list__item wow default">
                        <div class="line"></div>
                        <a href="/article/{{blog['id']}}-{{blog['slug']}}/{{blog['name']}}" class="thumbnail" title="{{blog['name']}}" target="_blank" rel="noopener noreferrer">
                            <img width="100%" height="100%" class="lazyload" src="{{default_thumb}}" data-src="data_thumb" alt="{{blog['name']}}" />
                            <time datetime="{{ago(blog['time'])}}">{{ago(blog['time'])}}</time>
                        ...
                        <div class="information">
                            <a href="/article/{{blog['id']}}-{{blog['slug']}}/{{blog['name']}}" class="title" title="{{blog['name']}}" target="_blank" rel="noopener noreferrer">
                                <span class="badge" style="display: inline-block">VIP</span>{{blog['name']}}
                            </a>
                            <a class="abstract" href="/article/{{blog['id']}}-{{blog['slug']}}" title="{{blog['name']}}" target="_blank" rel="noopener noreferrer">Mô tả bài viết!</a>
                            <div class="meta">
                                <ul class="items">
                                    <li><i class="fa fa-clock-o" aria-hidden="true"></i>12:0</li>
                                    <li><i class="fa fa-eye" aria-hidden="true"></i>2.6tr</li>
                                    <li><i class="fa fa-comment-o" aria-hidden="true"></i>55</li>
                                    <li><i class="fa fa-thumbs-up" aria-hidden="true"></i>120</li>
                                </ul>
                                <div class="last" style="display: none">
                                    ...
                                    <a class="link" target="_blank" rel="noopener noreferrer" href="Link chuyên mục mẹ">{{category['name']}</a>
                                </div>
                            </div>
                        </div>
                    </li>
